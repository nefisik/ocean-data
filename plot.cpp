...
void plot(matplot::axes_handle& ax1, int& i, std::vector<double>& distance, std::vector<double>& depth, std::vector<double>& temp, int& temp0)
{
...
int main()
{
	...
	{
		// ThreadVector.emplace_back([&](){plot(ax1, i, distance, depth, temp, temp0);});
		plot(ax1, i, distance, depth, temp, temp0);
	}
